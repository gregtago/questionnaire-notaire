      ...
      <table style="width:100%;border-collapse:collapse;margin-top:28px;">
        <tr>
          ...
          <td style="width:46%;padding:16px 20px;vertical-align:top;background:#f8f8f6;border:1px solid #e5e5e5;border-radius:4px;text-align:center;">
            ...
            <a href="https://tagot-my.sharepoint.com/:f:/g/personal/gregoiretagot_tagot_notaires_fr/IgC253vkNFUITa1Lod-DCtX5AZOna4WwK1RIBnjZDiJH-hE" target="_blank" style="display:inline-block;padding:10px 20px;background:#111;color:#fff;border-radius:4px;font-size:12px;font-weight:600;text-decoration:none;letter-spacing:.04em;">&#128206; Déposer mes pièces</a>
          </td>
        </tr>
      </table>
