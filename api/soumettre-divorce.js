  ...
  <div style="max-width:600px;margin:40px auto;background:#fff;border:1px solid #eee;border-radius:6px;overflow:hidden;">
    ...
    <div style="padding:28px 30px;">
      ...
      <div style="text-align:center;margin-top:20px;">
        <a href="https://tagot-my.sharepoint.com/:f:/g/personal/gregoiretagot_tagot_notaires_fr/IgC253vkNFUITa1Lod-DCtX5AZOna4WwK1RIBnjZDiJH-hE" target="_blank" style="display:inline-block;padding:12px 24px;background:#111;color:#fff;border-radius:4px;font-size:13px;font-weight:600;text-decoration:none;letter-spacing:.04em;">📎 Déposer mes pièces en ligne</a>
